                    ...
                    <div className="min-h-screen flex items-center justify-center w-full dark:bg-gray-950">
                        <div data-aos="flip-right" className="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md">
                            ...
                            <form  onSubmit={handleSignIn}>
                                ...
                                <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#1b206b] hover:bg-[#1b206b] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Login</button>
